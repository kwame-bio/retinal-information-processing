...
Introduces simulated retinal signal propagation using mathematical waveforms and visualization techniques. This notebook explores how retinal signals can be represented computationally and provides foundational plotting methods for later analyses.

### 02_retinal_dataset_loading.ipynb
Demonstrates how retinal datasets can be generated, loaded, structured, and prepared for computational analysis. The notebook focuses on organizing multidimensional biological signal data using NumPy and Pandas workflows.

### 03_retinal_noise_modeling.ipynb
Simulates biological noise within retinal systems by introducing stochastic variability into clean retinal signals. This notebook explores how signal degradation affects visual information transmission and compares noisy versus idealized responses.
...
- Fourier analysis of retinal signals
- Receptive field simulations
